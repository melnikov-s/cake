...
export const pluginBackendHostRequestSchema = z.discriminatedUnion("type", [
  ...
  z.object({ type: z.literal("call"), callId: z.uuid(), method: z.string().min(1).max(256), input: jsonValueSchema }),
...
export const pluginBackendHostMessageSchema = z.union([
  ...
  z.object({ type: z.literal("result"), callId: z.uuid(), ok: z.literal(true), value: jsonValueSchema }),
  z.object({ type: z.literal("result"), callId: z.uuid(), ok: z.literal(false), error: z.string().max(32_768) }),
