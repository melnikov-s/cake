...
export const WorkspaceBrowser = observer(function WorkspaceBrowser({ store, reviews, chat }: { store: BrowseStore; reviews: ReviewsStore; chat: MainChatStore }) {
