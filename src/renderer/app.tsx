...
export const Sidebar = observer(function Sidebar({ store, projects, chat, cakeChat, selection, onOpenSettings, onOpenCakeChat, onCreateCakeChat, onOpenSession, onCreateSession, onStartOneOffChat, onChooseProject, onToggle, onReloadPi }: { store: SidebarStore; projects: ProjectCatalogStore; chat: ProjectWorkbenchStore; cakeChat: GlobalChatStore; selection: AppSelection; onOpenSettings: () => void; onOpenCakeChat(sessionId?: string): void; onCreateCakeChat(): void; onOpenSession(workspacePath: string, sessionId: string): void; onCreateSession(workspacePath: string): void; onStartOneOffChat(): void; onChooseProject(): void; onToggle: () => void; onReloadPi?: () => void }) {
