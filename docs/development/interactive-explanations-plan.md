...
- [Widget visual-review implementation — Sol](cake://session/f22b7f8e-3d4e-49f3-8a52-251a045e2336) is implementing actual preview/capture/specialist acceptance in the existing widget-generation path. Owns new focused workflow/preview wiring and tests, not Astra's compiler/fixture files. This is production implementation, not another design/prototype assignment. It is not yet delivered or verified.
...
- Parent owns integration, shared guidance and later graph-only API cleanup. No automatic visual-review capability is claimed until the wired implementation passes verification.
