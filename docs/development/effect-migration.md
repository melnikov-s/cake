...
| 6. Cake Session domain    | Not started | Packet 6A begins at `projectSessions.list`, then migrates Project Session inspect/acquire/observe and commands above `PiSessions` while removing the corresponding `PiWorkspaceDriver` lifecycle path.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
